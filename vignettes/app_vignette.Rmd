...
A similar analysis is done for the non-breeding range of the species, see the NatureServe guidelines for a full description of how the migratory exposure index is calculated. Once you have finished exploring the maps click "Next".
