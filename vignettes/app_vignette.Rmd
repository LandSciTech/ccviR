...
For the demonstration species all the required data is included in the package, but for a real species you will need to either, [download](https://drive.google.com/file/d/1U6iVI60NvpFY_0cfnpe3gNw2Xpg66sJ4/view?usp=sharing) a prepared set of climate data, unzip it and store it in a convenient folder, or create your own (see `vignette("data_prep_vignette", package = "ccviR")`). 
