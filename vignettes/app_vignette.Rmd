...
If you have not already installed ccviR, begin by installing the development version of ccviR from [GitHub](https://github.com/) with:
...
Then, run the code below to get started:
