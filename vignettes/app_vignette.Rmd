...
For the demonstration species all the required data is included in the package, but for a real species you will need to download a prepared set of climate data or create your own (see `vignette("data_prep_vignette", package = "ccviR")`). 
...
On this tab, you will load the spatial data used by the index and see the results of the spatial analysis for exposure to climate change. The prepared climate data can be found under "clim_files > processed".
