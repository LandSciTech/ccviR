...
write.csv(
  data.frame(`Scenario_Name` = c("RCP 4.5", "RCP8.5"),
             ...
             `Future period` = "2050s",
             `Emissions scenario` = c("RCP 4.5", "RCP8.5"),
...
mat_classified <- raster(file.path(data_pth, "clim_files/processed/MAT_reclassRCP 4.5.tif"))
...
```{r fig.height=4, fig.width=4}
plot(clim_dat$mat$RCP.4.5, col = pal)
