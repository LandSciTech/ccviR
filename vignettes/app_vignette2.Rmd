...
In Section \@ref(individual) we provide a quick checklist to help individuals provide more accurate and repeatable judgements. In Section \@ref(group) we identify steps to further improve the accuracy of judgements by eliciting the judgements of a group.

<!--# Add this back when appendices are ready: Both checklists are informed by the extensive expert judgement literature (Appendix B), and the risk analysis literature (Appendix C). -->
