    ...
    fluidRow(
      column(
        ...
        div(
          ...
          check_comment_ui2(id, "B1", "B1) Exposure to sea level rise:",
                           choiceNames = valueNms,
                           choiceValues = valueOpts),
          check_comment_ui2(id, "B2a", "B2 a) Distribution relative to natural barriers",
                           choiceNames = valueNms,
                           choiceValues = valueOpts),
          check_comment_ui2(id, "B2b", "B2 b) Distribution relative to anthropogenic barriers",
                           choiceNames = valueNms,
                           choiceValues = valueOpts),
