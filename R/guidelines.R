...
<p>
    NOTES: This factor pertains to known or predicted dispersal or movement
    capacities and characteristics and ability to shift location in the absence
    of barriers as conditions change over time as a result of climate change.
    Species in which individuals exhibit substantial dispersal, readily move
    long distances as adults or juveniles, or exhibit flexible movement
    patterns should be better able to track shifting climate envelopes than are
    species in which dispersal and movements are more limited or inflexible.
    This factor pertains specifically to dispersal through unsuitable habitat,
    which, in most cases, is habitat through which propagules or individuals
    may move but that does not support reproduction or long-term survival. If
    all habitat is regarded as suitable (i.e., species can reproduce and
    persist in every habitat in which it occurs), then dispersal ability is
    assessed for suitable habitat. If appropriate, scoring of species whose
    dispersal capacity is not known can be based on characteristics of closely
    related species (or species of similar body size in the same major group)
    with similar and relevant morphological features.
</p>
<p>
    Barriers, which are here defined as features or areas that completely or
...
<p>
    Migratory species should be scored according to their ability to shift
    their distribution within the assessment area during the period of
    occupation or from one year to the next (whichever is larger).
</p>
<p>
    Species in which propagule dispersal is both synchronous among all members
    ...
    species that reproduces synchronously every 25-50 years and then dies.
</p>
<p>
    TOOLS: Seed biological trait data for some species can be found at
    http://data.kew.org/sid/sidsearch.html.
</p>
<p>
    Greatly Increase Vulnerability: Species is characterized by severely
         ...
         dispersal event.
           ...
           <p>
           Examples: plants with large or heavy propagules for which the disperser is
         extinct or so rare as to be ineffective; species with dispersal limited to
         vegetative shoots, buds, or similar structures that do not survive (at
                                                                             least initially) if detached from the parent; plants dispersed only
         ballistically.
</p>
<p>
    Increase Vulnerability: Species is characterized by highly restricted
         ...
         capability but exhibits a very high degree of site fidelity.
           ...
           <p>
           Examples: branchiopods whose resting stages sometimes are transported in
         mud attached to birds or mammals; small clams that may disperse while
         clamped onto bird feathers or frog toes; small, nonvolant animals of
         relatively low vagility, including small, slow-moving animals such as
         slugs, snails, and the smallest terrestrial salamanders that rarely shift
         location by more than 100 meters within a single year; many ant-dispersed
         plant species; plant or animal species with free-living propagules or
         individuals that may be carried more than 100 meters by a tornado or
         unusually strong hurricane or large flood but that otherwise rarely
         disperse more than 100 meters; plants that do not fit criteria for Greatly
         Increase Vulnerability but lack obvious dispersal adaptations (i.e.,
                                                                        propagules lack any known method for moving more than 100 meters away from
                                                                        the source plant); birds that exhibit an extremely high degree of site
         fidelity or exceptionally low rate of colonization of vacant suitable
         habitat.
</p>
<p>
    Somewhat Increase Vulnerability: Species is characterized by limited or
         moderate but not highly or severely restricted dispersal or movement
         ...
         dispersal likely is consistent with one of the following examples.
         </p>
           <p>
           Examples: species that exist in small isolated patches of suitable habitat
         but regularly disperse or move among patches that are up to 1,000 meters
         (rarely farther) apart; plants whose propagules are dispersed primarily by
         small animals (e.g., some rodents) that typically move propagules
         approximately 100-1,000 meters from the source (propagules may be cached or
                                                         transported incidentally on fur or feathers); plants dispersed by wind with
         low efficiency (e.g., species with inefficiently plumed seeds and/or that
                         occur predominantly in forests); many small but somewhat vagile animals
         (e.g., many small mammals and lizards); species whose individuals exist in
         small isolated patches of suitable habitat but regularly disperse or move
         among patches that are 100-1,000 meters (rarely farther) apart; plant and
         animal species whose propagules or individuals are dispersed by small
         animals (e.g., rodents, grouse) that regularly but perhaps infrequently
         move propagules approximately 100-1,000 meters from the source; many
         denning snakes and some pond-breeding amphibians that are otherwise
         terrestrial as adults) (note that these short-distance migratory animals
                                 may exhibit strong fidelity to natal areas but nevertheless generally
                                 include individuals that colonize or move into other nearby areas); birds
    that exhibit a high degree of site fidelity or relatively low rate of
    colonization of vacant suitable habitat (as in Increase Vulnerability but
                                             the degree site fidelity or colonization rate is not as extreme).
</p>
<p>
    ...
    have excellent innate or vector-aided dispersal capability.
    </p>
      <p>
      Examples: plant species regularly dispersed more than 1 km by large or
    mobile animals (e.g., plant has seeds that are cached, regurgitated, or
                    defecated at least 1 km from the source by birds [e.g., corvids, songbirds
                                                                      that eat small fleshy fruits] or mammals or that are transported on fur of
                    large mobile animals such as most Carnivora or ungulates); animal species
    that regularly disperse or move long distances via their own locomotory
    abilities (e.g., most large and some medium-sized mammals, most bats, many
               common birds); many plant species dispersed by wind with high efficiency
    (e.g., species with efficiently plumed seeds or very small propagules that
      occur predominantly in open areas); plant or animal species whose
    individuals often or regularly are dispersed more than 1 kilometer by air
    or ocean currents, or humans, including species that readily become
    established outside their native ranges as a result of intentional or
    unintentional translocations by humans; animal species whose populations
    within the assessment area are known to migrate facultatively according to
    changing environmental conditions (e.g., some northern finches and owls
                                       exhibit short or long migrations in some years but not in others);
    nonmigratory species whose populations may shift location by 1 kilometer or
    more in response to changing environmental conditions (e.g., the
                                                           black-backed woodpecker [Picoides arcticus] often makes substantial shifts
                                                           in its distribution in accordance with concentrations of wood-boring
                                                           insects); migratory species that show clear ability to track variable
    resources over broad geographies; bird species lacking a high degree of
...
<p>
    ...
    impacts (and, if so, score as Neutral).
</p>
<p>
    For plant species, the advantage of the C4 photosynthetic pathway for water
    ...
    respect to this factor has been adjusted accordingly.
</p>
<p>
    For nonmigratory species, 'range' refers to the range within the assessment
    ...
    dependent on such habitats within the assessment area.
</p>
<p>
    Note that temperature conditions and hydrological regimes often covary and
    ...
    be the overriding factor; otherwise they should be scored here.
</p>
<p>
    Greatly Increase Vulnerability: Completely or almost completely (&gt;90%
                                                                      of occurrences or range) dependent on a specific aquatic/wetland habitat or
    localized moisture regime that is likely to be highly vulnerable to loss or
    reduction with climate change.
    </p>
      <p>
      Examples: species dependent on small/isolated/shallow water-bodies or
    wetlands in arid landscapes; ephemeral-pool-dependent branchiopods; plants
    that are exclusively or very strongly associated with localized moist
    microsites (e.g., hanging gardens in arid landscapes).
</p>
<p>
    Increase Vulnerability: Moderately (50-90% of occurrences or range)
    ...
    highly vulnerable to loss or reduction with climate change.
      ...
      <p>
      Examples: certain amphibians that often breed in vernal pools but also
    regularly use other aquatic or wetland habitats; certain plants whose life
    cycles are highly synchronized with Mediterranean precipitation patterns in
    areas vulnerable to large changes in the amount and seasonal distribution
    of precipitation; desert or semidesert plants that frequently occur in but
    are not restricted to or almost restricted to moisture-accumulating
    microsites; plants (and animals that depend on these species) for which
    &gt;50% of populations occur in areas such as sandy soils that are highly
    prone to desiccation; plants that use the C4 photosynthetic pathway and
    that otherwise qualify for the Greatly Increase Vulnerability category.
</p>
<p>
    Somewhat Increase Vulnerability: Somewhat (10-50%) dependent on a strongly
    seasonal hydrologic regime and/or a specific aquatic/wetland habitat or
    localized moisture regime that is highly vulnerable to loss or reduction
    with climate change.
    </p>
      <p>
      Examples: plants (and animals that depend on these species) for which
    10-50% of populations occur in areas such as sandy soils that are sensitive
    to changes in precipitation; certain plants with ranges restricted to
    seasonal precipitation environments (e.g., summer rainfall deserts) and
    which have a moderate degree of adaptation to that seasonality; plants that
    use the C4 photosynthetic pathway and that otherwise qualify for the
    Increase Vulnerability category.
</p>
<p>
    ...
    availability; species dependent on springs tied to a regional aquifer that
    would not be expected to change significantly with climate change; aquatic
    species inhabiting caves fed by groundwater aquifers that are not expected
    to change significantly with climate change; plants that use the C4
    photosynthetic pathway and that otherwise qualify for the Somewhat Increase
...
<p>
    NOTES: This factor pertains to a species' response to specific disturbance
    ...
    frequency could result in complete habitat destruction.
</p>
<p>
    Be sure to also consider species that benefit from a lack of disturbance
    and may suffer due to disturbance increases when scoring this factor.
</p>
<p>
    TOOLS: Information on fire effects:
    http://www.fs.fed.us/database/feis/plants/index.html. For a map of modeled
    future fire regime, see Figure 2 in Krawchuk et al. (2009, PLoS ONE
    4:e5102).
</p>
<p>
    Increase Vulnerability: Strongly affected by specific disturbance regime,
    and climate change is likely to change the frequency, severity, or extent
    of that disturbance regime in a way that reduces the species' distribution,
    abundance, or habitat quality. For example, many sagebrush-associated
    species in regions predicted to experience increased fire
    frequency/intensity would be scored here due to the anticipated deleterious
    effects of increased fire on their habitat.
</p>
<p>
    Somewhat Increase Vulnerability: Moderately affected by specific
...
<p>
    ...
    disturbance regime in a way that increases the species' distribution.
</p>
<p>
    d) Dependence on ice, ice-edge, or snow cover habitats
</p>
<p>
    NOTES: This factor pertains to a species' dependence on habitats associated
    ...
    'Range' refers to the range within the assessment area.
</p>
<p>
    Greatly Increase Vulnerability: Highly dependent (&gt;80% of subpopulations
    or range) on ice- or snow-associated habitats; or found almost exclusively
    on or near ice or snow during at least one stage of the life cycle. For
    example, polar bear (Ursus maritimus) is strongly dependent on sea ice
    throughout its range.
</p>
<p>
    Increase Vulnerability: Moderately dependent (50-80% of subpopulations or
    range) on ice- or snow-associated habitats; or often found most abundantly
    ...
    is moderately to strongly associated with tidewater glaciers.
</p>
<p>
    Somewhat Increase Vulnerability: Somewhat (10-49% of subpopulations or
...
<p>
    NOTES: This factor pertains to a species' need for a particular
    ...
    climate change than are species that thrive under diverse conditions.
</p>
<p>
    This factor does NOT include habitat preferences based on temperature,
...
<p>
    If the idea of specificity to soil/substrate, geology, or specific physical
    or landscape features is not relevant to the species (e.g., many birds and
    mammals), choose Neutral.
</p>
<p>
    TOOLS: Map of deposits and rock types of the southwestern U.S.:
      ...
      <p>
      Map of serpentine areas of North America:
      http://botany.si.edu/projects/cpd/na/map5.htm.
</p>
<p>
    Increase Vulnerability: Highly dependent upon (i.e., more or less endemic
                                                    to, or &gt; 85% of occurrences found on) a particular highly uncommon
    landscape or geological feature or derivative (e.g., soil, water
                                                   chemistry).
    </p>
      <p>
      Examples: serpentine (broad and strict) endemic plants; plants of
    calcareous substrates where such substrates are uncommon (e.g., California,
                                                              karst in the southeastern U.S.); plants restricted to one or a few specific
    rock strata; species more or less restricted to inland sand dunes or shale
    barrens; obligate cave-dwelling organisms; springsnails restricted to
    springs with high dissolved CO2; fish species that require a highly
    uncommon substrate particle size, such as Colorado pikeminnows
    (Ptychocheilus lucius) that spawn only on rare cobble bars cleared of
    debris by seasonal high streamflows; many colonially nesting seabirds that
    are essentially restricted to predator-free islands for successful
    reproduction.
</p>
<p>
    Somewhat Increase Vulnerability: Moderately dependent upon a particular
    uncommon landscape or geological feature or derivative, i.e., (1) an
    ...
    dependence; species moderately restricted to active coastal sand dunes,
    cliffs, salt flats (including shorebirds that require sodic soils), inland
    waters within a particular salinity range, or nondominant rock types such
    as occasional igneous rock intrusions within a landscape mostly dominated
    by sedimentary and/or metamorphic rocks; species that inhabit multiple
    geological features each of which is uncommon; fish species that require a
    specific substrate particle size, if that of stream bottom type is not one
    of the dominant types within the species range.
</p>
<p>
...
<p>
    Examples: plants (e.g., red spruce) that are usually associated with acidic
    ...
    any specific landscape or geological feature or derivative, such as common
    yarrow (Achillea millefolium), coyote (Canis latrans), and many other
    plants and animals.
</p>
<p>
...
<p>
    NOTES: The primary impact of climate change on many species may occur via
    effects on synchrony with other species on which they depend (Parmesan
    2006, ARES 37:637), rather than through direct physiological stress.
</p>
<p>
...
<p>
    ...
    not have specialized habitat requirements.
</p>
<p>
    Habitat refers to any habitat (e.g., for reproduction, feeding,
    ...
    under factor C4d (Dependence on other species for propagule dispersal).
</p>
<p>
    This factor is concerned specifically with habitats generated or maintained
...
<p>
    Increase Vulnerability: Required habitat is generated primarily by one
    species.
</p>
<p>
    Examples: several insect species (e.g., the beetle Onthophilus giganteus)
    that depend entirely on southeastern pocket gopher (Geomys pinetis) tunnels
    for required habitat; the spider Masoncus pogonophilus, which depends on
    habitat provided by colony chambers of the Florida harvester ant
    (Pogonomyrmex badius); lichens (e.g., Nephroma occultum) strongly
    associated with old-growth forests of the Pacific Northwest; animals that
    require marshes dominated by a single plant species (such as Spartina sp.
    or Typha sp.).
</p>
<p>
    Somewhat Increase Vulnerability: Required habitat is generated by only a
    few species.
</p>
<p>
    Examples: certain cacti that depend on a few specific plant species for
    creating required specific habitat conditions necessary for seedling
    establishment; plants species that depend on biological soil crusts for
    favorable conditions for seed germination, water and nutrient flow to
    vegetation, and soil stability; plant species with preference for
    particular canopy species like long leaf pine (Pinus palustris); species
    such as nesting burrowing owls (Athene cunicularia) that depend on
    excavations made by relatively few species of burrowing mammals; birds such
    as marbled murrelets (Brachyramphus marmoratus) that strongly depend on a
    few species of large trees to provide suitable nesting platforms; certain
    plant species that depend on large grazing animals to generate habitats
    (localized disturbances) required for establishment and early growth.
</p>
<p>
    ...
    requirements do not involve species-specific processes.
</p>
<p>
    Examples: many mammal species that do not rely on burrows or shelters made
    by one or a few other species; many bird species that do not depend on one
    or a few other species to provide suitable nesting or foraging sites; most
    species of reptiles, amphibians, fishes, aquatic invertebrates, and
    butterflies and moths; epiphytic species (orchids, lichens, bromeliads)
    with no host preference; many species of forest understory plants that
    thrive under a wide range of forest tree species.
</p>
<p>
    b) Dietary versatility (animals only)
</p>
<p>
    NOTES: This factor pertains to the diversity of food types consumed by
...
<p>
    Note that the relationship between freshwater mussels and their larval
    hosts should be scored only under factor C5d (Dependence on other species
    for propagule dispersal).
</p>
<p>
    Increase Vulnerability: Completely or almost completely (&gt;90%)
...
<p>
    Examples: Clarks nutcracker (Nucifraga columbiana), which depends heavily
    on the seeds of whitebark pine (Pinus albicaulis); red knot, some
    populations of which during spring migration may be completely or almost
    completely dependent on horseshoe crab (Limulus) eggs.
</p>
<p>
    Somewhat Increase Vulnerability: 'Completely or almost completely (&gt;90%)
    dependent during any part of the year on (1) a few species from a
    restricted taxonomic group or (2) a narrow guild the members of which are
    thought to respond similarly to climate change.
    </p>
      <p>
    ...
    which is dependent on a few mistletoe species; swifts and swallows that are
    dependent on aerial insects (often a limited number of species at any
                                 particular time) that may become unavailable or less available as a result
    of climate change (e.g., through increased incidence of prolonged rainy
                       conditions that restrict aerial feeding opportunities, or increased
                       incidence of conditions that reduce populations of aerial insects).'
</p>
<p>
    Neutral: 'Diet flexible; during any season species readily switches among
    multiple food resources according to availability; not strongly dependent
    on one or a few species; omnivorous, with diet including numerous species
    of both plants and animals.
    </p>
      <p>
      Examples: most Carnivora, ungulates, nonmigratory birds, amphibians,
    reptiles, fishes, and many Lepidoptera (e.g., mule deer seasonally may
                                            focus their foraging on only a few favored plant species, but in the
                                            absence of those species they readily switch to other species); great
    horned owl (Bubo virginianus), which has a flexible diet and is not
    strongly dependent on one or a few species (although its diet may be
                                                dominated by one or a few readily available species in a particular
                                                location or season); black-capped chickadee (Poecile atricapillus) and
    other birds that are highly opportunistic during any season and readily
    switch among different food resources as availability changes.'
</p>
<p>
    c) Pollinator versatility (plants only)
</p>
<p>
    NOTES: Quantitative thresholds loosely follow data in Waser et al. (1996,
    ...
    Ecology, Princeton Press).
</p>
<p>
    In some cases, sympatric, sequentially flowering species may enhance
    ...
    higher (Hegland et al. 2009, Ecology Letters 12:184).
</p>
<p>
    TOOLS: 'The Inouye Pollinator Reference Database is a source for literature
    references to pollination:
...
<p>
    Increase Vulnerability: Completely or almost completely dependent on one
    species for pollination (&gt; 90% of effective pollination accomplished by
    1 species) or, if no observations exist, morphology suggests very
    significant limitation of potential pollinators (e.g., very long corolla
    tube).
</p>
<p>
    Somewhat Increase Vulnerability: Completely or almost completely dependent
    on 2-4 species for pollination (&gt; 90% of effective pollination
...
<p>
    ...
    Score wind-pollinated species as Neutral.
</p>
<p>
    d) Dependence on other species for propagule dispersal
</p>
<p>
    NOTES: Can be applied to plants or animals. Examples: Different species of
    freshwater mussels can be dispersed by one to many fish species; fruit
    dispersal by animals.
</p>
<p>
    Increase Vulnerability: Completely or almost completely (roughly &gt; 90%)
    dependent on a single species for propagule dispersal.For example,
    whitebark pine would fit here because Clark's nutcracker is the primary
    dispersal agent.
</p>
<p>
    Somewhat Increase Vulnerability: Completely or almost completely (roughly
    &gt; 90%) dependent on a small number of species for propagule dispersal.
    For example, a freshwater mussel for which only a few species of fish can
    disperse larvae.
</p>
<p>
    Neutral: Disperses on its own (most animals, wind-dispersed plants) OR
    propagules can be dispersed by more than a few species (many plants).
</p>
<p>
    e) Sensitivity to pathogens or natural enemies
</p>
<p>
    NOTES: This factor refers to pathogens and natural enemies (e.g.,
...
<p>
    Increase Vulnerability: Species is negatively affected to a high degree by
    a pathogen or natural enemy that is likely to increase in distribution,
    abundance, or impact as a result of climate change. Example: The
    cold-sensitive non-native hemlock woolly adelgid commonly causes a high
    level of mortality in eastern hemlock, and the
    distribution/abundance/impact of the adelgid may increase in areas where
    winter temperatures become milder.
</p>
<p>
    Somewhat Increase Vulnerability: Species is negatively affected to a
    moderate degree by a pathogen or natural enemy that is likely to increase
    in distribution, abundance, or impact as a result of climate change.
</p>
<p>
    Neutral: There is no indication that the species is currently or in the
    foreseeable future likely to be significantly affected by a pathogen or
    ...
    pathogens that depend/thrive on relatively cold/moist conditions.
</p>
<p>
...
<p>
    ...
    competitor is favored by projected future climates.
</p>
<p>
    Increase Vulnerability: Strongly affected by a native or non-native
    competing species that is likely to be favored by climate change.
</p>
<p>
    Somewhat Increase Vulnerability: Moderately affected to a moderate degree
    by a native or non-native competing species that is likely to be favored by
    climate change.
</p>
<p>
    Neutral: Little or no response to a native or non-native species that is
    likely to shift its distribution or abundance due to climate change OR
...
<p>
    g) Forms part of an interspecific interaction not covered by C5a-f
</p>
<p>
    NOTES: Can be applied to plants or animals. Here an interspecific
    ...
    an ant colony for protection against herbivores.
</p>
<p>
    Increase Vulnerability: Requires an interaction with a single other species
    for persistence.
</p>
<p>
    Somewhat Increase Vulnerability: Requires an interaction with a one member
    of a small group of taxonomically related species for persistence. Could
...
<p>
    NOTES: Species with less standing genetic variation will be less able to
...
<p>
    Because measures of genetic variability vary across taxonomic groups, there
...
<p>
    Increase Vulnerability: Genetic variation reported as 'very low' compared
    to findings using similar techniques on related taxa, i.e., lack of genetic
    variation has been identified as a conservation issue for the species.
</p>
<p>
    Somewhat Increase Vulnerability: Genetic variation reported as 'low'
    compared to findings using similar techniques on related taxa.
</p>
<p>
    Neutral: Genetic variation reported as 'average' or 'high' compared to
    findings using similar techniques on related taxa.
</p>
<p>
    b) Occurrence of bottlenecks in recent evolutionary history (use only if
    C5a is 'unknown')
</p>
<p>
    NOTES: In the absence of rangewide genetic variation information (C5a),
...
<p>
    Somewhat Increase Vulnerability: Evidence that total population was reduced
    to 251-1000 mature individuals, to less than 10 occurrences, and/or that
...
<p>
    Increase Vulnerability: Genetic variation of the species is assumed to be
    'very low' in the assessment area because the species is restricted to
...
<p>
    Somewhat Increase Vulnerability: Genetic variation assumed to be 'low' in
    the assessment area due to known disruptions or barriers to gene flow among
...
<p>
    ...
    area based on reproductive system. Includes species that have either mixed
    mating systems or are obligate outcrossers AND there are no known major
    disruptions to gene flow.
</p>
<p>
    6) Phenological Response to Changing Seasonal Temperature or Precipitation
    Dynamics
</p>
<p>
    NOTES: Recent research suggests that some phylogenetic groups are declining
...
<p>
    TOOLS: Some phenological information can be gleaned from papers listed in
    the Inouye Phenology Database,
    http://www.mendeley.com/groups/2544001/inouye-pollinator-reference-database/.
    The National Phenology Network website is http://www.usanpn.org/.
</p>
<p>
    Increase Vulnerability: Seasonal temperature or precipitation dynamics
    within the species' range show detectable change, but phenological
    variables measured for the species show no detectable change.
</p>
<p>
    Somewhat Increase Vulnerability: Seasonal temperature or precipitation
...
<p>
    ...
    range show detectable change, and phenological variables measured for the
    species show detectable change which is average compared to other species
...
<p>
    1) Documented Response to Recent Climate Change (e.g., range contraction or
    phenology mismatch with critical resources)
</p>
<p>
    NOTES: This factor pertains to the degree to which a species is known to
    ...
    brumata) caterpillars, or honey-buzzards (Pernis apivorus) with wasps.
</p>
<p>
    Note that not all responses to climate change necessarily indicate
    ...
    population) should also be scored as Neutral.
</p>
<p>
    Greatly Increase Vulnerability: Distribution or abundance undergoing major
    reduction (&gt;70% over 10 years or three generations) believed to be
    associated with climate change.
</p>
<p>
    Increase Vulnerability: Distribution or abundance undergoing moderate
    reduction (30-70% over 10 years or three generations) believed to be
    associated with climate change.
</p>
<p>
    Somewhat Increase Vulnerability: Distribution or abundance undergoing small
    but measureable (10-30% over 10 years or three generations) believed to be
    associated with climate change.
</p>
<p>
...
<p>
    NOTES: This factor can include both distribution models and population
    ...
    al. 2008, Calosi et al. 2008).
</p>
<p>
    If necessary, check multiple boxes to reflect variation in model output.
</p>
<p>
    Greatly Increase Vulnerability: Predicted future range disappears entirely
    from the assessment area OR predicted future abundance declines to zero as
    a result of climate change processes.
</p>
<p>
    Increase Vulnerability: Predicted future range represents 50-99% decrease
    relative to current range within the assessment area OR predicted future
    abundance represents 50-99% decrease associated with climate change
    processes.
</p>
<p>
    Somewhat Increase Vulnerability: Predicted future range represents a 20-50%
    decrease relative to current range within the assessment area OR predicted
    future abundance represents 20-50% decrease associated with climate change
    processes.
</p>
<p>
    Neutral: Predicted future range represents an increase, no change, or a
    decrease of less than a 20% relative to current range within the assessment
    area OR predicted future abundance increases, remains stable, or decreases
    &lt; 20% as a result of climate change processes.
</p>
<p>
    3) Overlap of Modeled Future (2050) Range with Current Range
</p>
<p>
    NOTES: Distribution models of current and projected future ranges should
    ...
    double-counting model results.
</p>
<p>
    Greatly Increase Vulnerability: There is no overlap between the current and
    predicted future range within the assessment area.
</p>
<p>
    Increase Vulnerability: Predicted future range overlaps the current range
    by 30% or less within the assessment area.
</p>
<p>
    Somewhat Increase Vulnerability: Predicted future range overlaps the
    current range by 30-60% within the assessment area.
</p>
<p>
