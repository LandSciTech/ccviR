...
params: 
    ...
    clim_vars: !r list(mat = system.file("extdata/clim_files/processed/MAT_reclassRCP 4.5.tif", package = "ccviR"), cmd = system.file("extdata/clim_files/processed/CMD_reclassRCP 4.5.tif", package = "ccviR"))
